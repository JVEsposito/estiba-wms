...
class ProcesoPrefrioFolio extends Model implements PerteneceATemporada
{
    ...
    /** La temporada es la del proceso de prefrío. */
    public function temporadaOperacionalId(): ?string
    {
        return $this->proceso?->temporadaOperacionalId();
    }
}
