...
class GuardarTemporadaMaterialRequest extends FormRequest
{
    ...
    {
        $temporada = $this->route('temporadaMaterial');
        $temporadaId = $temporada instanceof TemporadaMaterial ? $temporada->id : null;
        ...
        return [
            'codigo' => [
                ...
                Rule::unique('temporadas_materiales', 'codigo')->ignore($temporadaId),
            ],
