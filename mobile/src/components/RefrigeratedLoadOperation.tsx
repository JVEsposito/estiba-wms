...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.cyan, fontSize: 12, fontWeight: '900', letterSpacing: 1.3 },
  moduleTitle: { marginTop: 3, color: colors.text, fontSize: 20, fontWeight: '900' },
  moduleSubtitle: { marginTop: 3, color: colors.muted, fontSize: 13 },
  error: { marginBottom: 9, padding: 10, borderRadius: 9, borderWidth: 1, borderColor: colors.red, backgroundColor: '#421B21', color: '#FFD0D2', fontSize: 14 },
  notice: { marginBottom: 9, padding: 10, borderRadius: 9, borderWidth: 1, borderColor: colors.green, backgroundColor: colors.greenDark, color: colors.text, fontSize: 14, fontWeight: '800' },
  ...
  loadOrder: { marginTop: 4, color: colors.muted, fontSize: 13 },
  priority: { color: colors.amber, fontSize: 11, fontWeight: '900' },
  ...
  emptyText: { marginTop: 4, color: colors.muted, fontSize: 13 },
  ...
  loadHeaderSubtitle: { marginTop: 3, color: colors.muted, fontSize: 13 },
  ...
  concentrationLabel: { color: colors.text, fontSize: 11, fontWeight: '900' },
  ...
  panelEyebrow: { color: colors.cyan, fontSize: 11, fontWeight: '900', letterSpacing: 1.1 },
  panelTitle: { marginTop: 3, color: colors.text, fontSize: 15, fontWeight: '900' },
  routeHint: { marginTop: 4, color: colors.muted, fontSize: 12, lineHeight: 16 },
  ...
  routeOrderText: { color: colors.text, fontSize: 13, fontWeight: '900' },
  routeCopy: { flex: 1, minWidth: 0 },
  routeFolio: { color: colors.text, fontSize: 13, fontWeight: '900' },
  routeLocation: { marginTop: 2, color: colors.muted, fontSize: 11 },
  blockers: { marginTop: 2, color: colors.red, fontSize: 11 },
  routeStatus: { color: colors.green, fontSize: 11, fontWeight: '900' },
  ...
  selectedFolioLocation: { marginTop: 3, color: colors.muted, fontSize: 12 },
  fieldLabel: { marginTop: 5, color: colors.muted, fontSize: 12, fontWeight: '900' },
  ...
  dockText: { color: colors.muted, fontSize: 12, fontWeight: '900' },
  ...
  operationNote: { color: colors.muted, fontSize: 11, lineHeight: 14 },
  ...
  modalText: { marginTop: 5, color: colors.muted, fontSize: 14 },
  ...
  incidentTypeText: { color: colors.muted, fontSize: 13, fontWeight: '800' },
