...
<html lang="es">
    ...
    <body>
        ...
        <main class="office-app is-hidden" id="officeApp">
            <header class="office-topbar"><div class="brand-lockup"><span class="office-logo office-logo--small">⇄</span><span><strong>ESTIBA WMS</strong><small>CUENTA ENVASES</small></span></div><nav><a href="/oficina/gerencia">Gerencia</a><a href="/oficina/romana">Romana</a><a class="is-active" href="/oficina/envases/cuenta-corriente">Cuenta envases</a><a href="/oficina/accesos">Accesos</a></nav><div class="identity"><span class="identity__avatar" id="officeInitials">CE</span><span><strong id="officeUserName">Usuario</strong><small id="officeUserRole">Consulta</small></span><button id="officeLogoutButton" type="button">Cerrar sesión</button></div></header>
            <section class="accounts-workspace">
                <header class="accounts-heading"><div><p class="eyebrow">CONTROL Y CONCILIACIÓN</p><h1>Cuenta corriente de envases</h1><p>Saldo continuo entre temporadas, con temporada como filtro y no como reinicio.</p></div><button class="secondary-button" id="reloadButton" type="button">↻ Actualizar</button></header>
                <div class="accounts-kpis"><article><span>MOVIMIENTOS CONFIRMADOS</span><strong id="confirmedCount">0</strong></article><article><span>PENDIENTES DE VALIDACIÓN</span><strong id="pendingCount">0</strong></article><article><span>OBSERVADOS</span><strong id="observedCount">0</strong></article><article><span>ÚLTIMA SINCRONIZACIÓN</span><strong id="syncTime">—</strong></article></div>
                <section class="panel accounts-filters"><form id="filtersForm"><input name="buscar" placeholder="Guía, recepción o cliente"><select name="cliente_id"><option value="">Todos los clientes</option></select><select name="temporada_id"><option value="">Todas las temporadas</option></select><select name="tipo_envase"><option value="">Todos los envases</option></select><select name="estado_revision"><option value="">Toda revisión</option><option value="pendiente">Pendiente</option><option value="revisado">Revisado</option><option value="observado">Observado</option></select><input name="desde" type="date"><input name="hasta" type="date"><button class="primary-button" type="submit">Aplicar filtros</button></form></section>
